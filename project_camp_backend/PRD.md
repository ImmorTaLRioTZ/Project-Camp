...
- `POST /` - Create task (secured, Admin/Project Admin)
- `GET /:taskId` - Get task details (secured, role-based)
- `PUT /:taskId` - Update task (secured, Admin/Project Admin)
- `DELETE /:taskId` - Delete task (secured, Admin/Project Admin)
- `POST /:taskId/subtasks` - Create subtask (secured, Admin/Project Admin)
- `PUT /:taskId/subtasks/:subTaskId` - Update subtask (secured, role-based)
- `DELETE /:taskId/subtasks/:subTaskId` - Delete subtask (secured, Admin/Project Admin)

**Note Routes** (`/api/v1/projects/:projectId/notes/`)

- `GET /` - List project notes (secured, role-based)
- `POST /` - Create note (secured, Admin/Project Admin)
- `GET /:noteId` - Get note details (secured, role-based)
- `PUT /:noteId` - Update note (secured, Admin/Project Admin)
- `DELETE /:noteId` - Delete note (secured, Admin/Project Admin)
