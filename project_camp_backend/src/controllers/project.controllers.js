...
const getProjects = asyncHandler(async(req, res) => {
    ...
    if(!projects) {
        throw new APIError(404, "Projects nto found");
    }
    return res
        .status(200)
        .json(
...
const deleteMembers = asyncHandler(async(req, res) => {
    ...
    if(projectMember.role === userRoleEnum.ADMIN) {
        throw new APIError(403, "Cannot remove an admin from the project");
    }

    projectMember = await ProjectMember.findOneAndDelete({_id: projectMember._id});
